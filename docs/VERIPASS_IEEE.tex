...
\fancyhead[R]{\small ISSN: 2654-3788 \\ e-ISSN: 2654-4229 \\ \url{https://doi.org/10.32493/jtsi.v8i1.XXXXX}}
    \fancyfoot[C]{
        \parbox{\textwidth}{
            ...
            \end{minipage} \\
            Copyright \copyright\ 2026 Dewantoro Triatmojo, Elbert Chailes, Irfan Musthofa, Dr. Phil. Eng. Hari Purnama S.Si., M.Si
        }
    }
...
\twocolumn[
  \begin{center}
    ...
    \vspace{1.5em}
    {\large \bfseries Dewantoro Triatmojo$^1$, Elbert Chailes$^2$, Irfan Musthofa$^3$, Dr. Phil. Eng. Hari Purnama S.Si., M.Si$^4$ \par}
    \vspace{1em}
...
\bibitem{alzahrani2022} Alzahrani, A. G., \& Aljehani, A. (2022). Blockchain-based system for vehicle identity management and tracking. \textit{Applied Sciences}, 12(15), 7679.
